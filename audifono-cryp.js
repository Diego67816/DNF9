...
function calculateTotal() {
    ...
    rows.forEach(row => {
        ...
        switch (productName) {
            case 'Audifono Inalambrico M20':
                pricePerUnit = quantity >= 10 ? 2450 : 3000;
                break;
            case 'Audifono Inalambrico M10':
                pricePerUnit = quantity >= 10 ? 2200 : 3000;
                break;
            case 'Audifono Inalambrico M19':
                pricePerUnit = quantity >= 10 ? 2500 : 3000;
                break;
            case 'Audifono Inalambrico M30':
                pricePerUnit = quantity >= 10 ? 2550 : 3000;
                break;
