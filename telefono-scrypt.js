...
function calculateTotal() {
    ...
    rows.forEach(row => {
        ...
        switch (productName) {
            case 'Sansung Galaxy A05':
                pricePerUnit = quantity >= 5 ? 145 : 160;
                break;
            case 'Xiaomi Redmi 13C':
                pricePerUnit = quantity >= 5 ? 155 : 170;
                break;
            case 'Sansung Galaxy A15':
                pricePerUnit = quantity >= 5 ? 132 : 155;
                break;
            case 'Xiaomi Redmi A3':
                pricePerUnit = quantity >= 5 ? 94 : 110;
                break;
            case 'Tecno Spark Pop 7':
                pricePerUnit = quantity >= 5 ? 98 : 115;
                break;
        }
